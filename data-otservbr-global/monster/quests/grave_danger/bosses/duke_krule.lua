...
monster.loot = {
	...
	{name = "terra hood", chance = 400},
	{name = "yellow gem", chance = 9500},
	{name = "young lich worm", chance = 5800},
	{name = "bear skin", chance = 400},
	{name = "noble amulet", chance = 400},
...
monster.attacks = {
	...
	{name ="combat", interval = 1800, chance = 60, type = COMBAT_MANADRAIN, minDamage = -700, maxDamage = -1000, length = 7, spread = 2, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1800, chance = 19, type = COMBAT_PHYSICALDAMAGE, minDamage = -700, maxDamage = -1000, length = 7, spread = 3, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -700, maxDamage = -800, radius = 10, effect = CONST_ME_HITBYFIRE, target = false}
}
