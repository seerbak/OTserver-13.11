...
monster.loot = {
	...
	{name = "young lich worm", chance = 400},
	{name = "embrace of nature", chance = 400},
	{id = 31592, chance = 400}, -- signet ring
	{name = "terra helmet", chance = 400},
	{name = "final judgement", chance = 400},
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -700, maxDamage = -1000, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_MANADRAIN, minDamage = -700, maxDamage = -1000, radius = 5, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 1800, chance = 89, type = COMBAT_PHYSICALDAMAGE, minDamage = -800, maxDamage = -1600, length = 7, spread = 3, target = false}
}
