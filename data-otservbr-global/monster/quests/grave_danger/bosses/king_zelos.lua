...
monster.loot = {
	...
	{name = "mortal mace", chance = 400},
	{name = "golden hyaena pendant", chance = 400},
	{name = "bow of cataclysm", chance = 400},
	{name = "galea mortis", chance = 400},
	{name = "shadow cowl", chance = 400},
	{name = "toga mortis", chance = 400},
}

monster.attacks = {
	{name = "melee", type = COMBAT_PHYSICALDAMAGE, interval = 2000, minDamage = -1300, maxDamage = -3100},
	{name = "combat", type = COMBAT_FIREDAMAGE, interval = 2000, chance = 15, length = 8, spread = 0, minDamage = -1600, maxDamage = -3200, effect = CONST_ME_HITBYFIRE},
	{name = "combat", type = COMBAT_LIFEDRAIN, interval = 2000, chance = 10, length = 8, spread = 3, minDamage = -1000, maxDamage = -1600, effect = CONST_ME_SMALLCLOUDS},
	{name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 30, radius = 6, minDamage = -1300, maxDamage = -1500, effect = CONST_ME_MORTAREA, target = false},
	{name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 20, length = 8,  minDamage = -1800, maxDamage = -2000, effect = CONST_ME_MORTAREA, target = false}
}
