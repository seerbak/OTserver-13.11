...
function ExerciseEvent(playerId, tilePosition, weaponId, dummyId)
	...
	onExerciseTraining[playerId].event = addEvent(ExerciseEvent, vocation:getAttackSpeed(10) / configManager.getFloat(configKeys.RATE_EXERCISE_TRAINING_SPEED), playerId, tilePosition, weaponId, dummyId)
	return true
end
