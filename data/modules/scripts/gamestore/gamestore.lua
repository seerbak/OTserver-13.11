...
GameStore.Categories = {
	{
		...
		offers = {
			{
				icons = { "Memory_Box.png" },
				name = "Memory Box",
				price = 350,
				itemtype = 19397,
				count = 1,
				description = "Box Especializada, Podras obtener aleatoriamente lion Shield,Sooft boots,wand of destruction,Gnome Helmet, Umbral master Spellbook,Bow of cataclysm, Dwarven legs, cobra Boots, Fabulous Legs,Gnome Armor,Cobra Rod, Terra Helmet,Lion Axe,Umbral Master Mace,Umbral MAsterblade, Elven Mail",
			...
			},
			{
				...
				itemtype = 34109,
				count = 1,
				description = "Bolsa contiene aleatoriamente parte del Set Soul",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				...
				itemtype = 39546,
				count = 1,
				description = "Bolsa contiene aleatoriamente parte del Set Primal",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Crystal_Coin.gif" },
				name = "10 Crystal Coins",
				price = 25,
				itemtype = 3043,
				count = 10,
				description = "Obtendras 10 crystal coins",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
	},
	...
	--nuevos items
	{
		icons = { "Draptor_Dollbp.png" },
		name = "Nuevos items",
		rookgaard = true,
		subclasses = {"Pociones", "Canje Tournament Coins"},
	},
	-- Pociones
	{
		icons = { "Category_Potions.png" },
		...
		offers = {
			{
                ...
                itemtype = 36726,
				count = 1,
				description = "Potion personalizada,Aumenta las posibilidades de activación de hechizos ofensivos en un 5% durante 1 hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
                ...
                itemtype = 36728,
				count = 1,
				description = "Potion personalizada, Hace que las muertes cuenten dos veces para el Bestiario durante una hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
                ...
                itemtype = 36741,
				count = 1,
				description = "Potion personalizada, Aumenta el daño al hacer que tus ataques y hechizos afecten la sensibilidad de los objetivos en 8% o más durante una hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
                ...
                itemtype = 36734,
				count = 1,
				description = "Potion personalizada, Aumenta la protección en un 8% durante una hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
			...
			},
            {
                ...
                itemtype = 36723,
				count = 1,
				description = "Potion personalizada, Restablece los tiempos de reutilización de todos los hechizos.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
			...
			},
            {
                ...
                itemtype = 36724,
				count = 1,
				description = "Potion personalizada, Aumenta la probabilidad de golpe crítico en un 5% durante una hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
                ...
                itemtype = 36727,
				count = 1,
				description = "Potion personalizada, Duplica el loot de cada monstruo normal que mates durante una hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
            {
                ...
                itemtype = 36725,
				count = 1,
				description = "Potion personalizada, Llena la stamina en una hora",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
		-- Exclusive Offers
		}, {
		icons = { "Midnight_Panther_Dollbp.png" },
		name = "Canje Tournament Coins",
		parent = "Nuevos items",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
